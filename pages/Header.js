const Header = () => {
  return (
    <>
      <header className="bg-teal-500 w-full px-4 py-3 flex justify-center border-b-4 border-green-600">
          ...
          <div className="my-4">
            ...
            <div>
              <div className="relative mt-4 flex justify-between">
                <a
                  href="#"
                  className="bg-green-900 text-indigo-100 font-bold mt-2 px-4 py-2 rounded-full text-xs uppercase"
                >
                  Enroll Now
                </a>
              </div>
